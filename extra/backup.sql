...
(
    ...
    `KIND_NAME`    varchar(15) CHARACTER SET utf8 COLLATE utf8_general_ci  NULL     DEFAULT NULL,
    `TITLE`        varchar(63) CHARACTER SET utf8 COLLATE utf8_general_ci  NULL     DEFAULT '',
    ...
    `HEAD_URL`     varchar(63) CHARACTER SET utf8 COLLATE utf8_general_ci  NULL     DEFAULT 'default',
    `CREATED_TIME` timestamp(0)                                            NOT NULL DEFAULT CURRENT_TIMESTAMP(0),
    PRIMARY KEY (`ID`) USING BTREE,
    INDEX `user_index` (`USER_ID`) USING BTREE,
    INDEX `kind_index` (`KIND_NAME`) USING BTREE
) ENGINE = InnoDB
  AUTO_INCREMENT = 28
...
-- ----------------------------
INSERT INTO `course`
VALUES (1, 1, 'C++', 'C++精通指南', '教你3天速成C++', 2, 1, 'M00/00/00/rBExSlz_uuGALrS9AAFgG0NhN1s731.png',
        '2019-06-11 22:29:53');
INSERT INTO `course`
...
VALUES (5, 7, 'Java', 'Java一天速成指南', '教你如何一天成为Java大神', 0, 0, 'M00/00/00/rBExSl0AVciAYTw1ABH2XVXhAxQ394.jpg',
        '2019-06-12 09:30:48');
INSERT INTO `course`
VALUES (6, 7, 'Java', 'Java大神宝典', 'Java大神宝典', 0, 0, 'M00/00/00/rBExSl0AVj-ALzrKAEomjjGj58g735.jpg',
        '2019-06-12 09:32:47');
INSERT INTO `course`
...
VALUES (25, 7, 'Java', 'Java 入门指南', 'Java 入门指南', 1, 1, 'M00/00/00/rBExSl0AaPWAOo3QAABYCTqswWk297.jpg',
        '2019-06-12 10:52:37');
INSERT INTO `course`
VALUES (26, 7, 'C', 'C 入门教学', 'C讲义', 1, 1, 'M00/00/00/rBExSl0AaVmAD_GZAABKKampy9w397.jpg', '2019-06-12 10:54:17');
INSERT INTO `course`
...
(
    ...
    `TITLE`        varchar(63) CHARACTER SET utf8 COLLATE utf8_general_ci NULL     DEFAULT NULL,
    `CREATED_TIME` timestamp(0)                                           NOT NULL DEFAULT CURRENT_TIMESTAMP(0),
    PRIMARY KEY (`ID`) USING BTREE,
    INDEX `course_index` (`COURSE_ID`) USING BTREE
) ENGINE = InnoDB
  AUTO_INCREMENT = 32
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci
...
(
    ...
    `CREATED_TIME` timestamp(0)                                    NOT NULL DEFAULT CURRENT_TIMESTAMP(0),
    PRIMARY KEY (`ID`) USING BTREE,
    INDEX `user_course_index` (`USER_ID`, `COURSE_ID`) USING BTREE
) ENGINE = InnoDB
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci
...
(
    ...
    `CREATED_TIME` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0),
    PRIMARY KEY (`ID`) USING BTREE,
    INDEX `USER_COMMIT_ID` (`USER_ID`, `COMMENT_ID`) USING BTREE
) ENGINE = InnoDB
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci
...
(
    ...
    `CREATED_TIME` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0),
    PRIMARY KEY (`ID`) USING BTREE,
    INDEX `course_user_index` (`COURSE_ID`, `USER_ID`) USING BTREE
) ENGINE = InnoDB
  AUTO_INCREMENT = 47
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci
...
(
    ...
    `VIDEO_URL`    varchar(63) CHARACTER SET utf8 COLLATE utf8_general_ci  NULL     DEFAULT NULL,
    `CREATED_TIME` timestamp(0)                                            NOT NULL DEFAULT CURRENT_TIMESTAMP(0),
    PRIMARY KEY (`ID`) USING BTREE,
    INDEX `chapter_index` (`CHAPTER_ID`) USING BTREE
) ENGINE = InnoDB
  AUTO_INCREMENT = 47
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci
...
(
    ...
    `CREATED_TIME` timestamp(0)                                    NOT NULL DEFAULT CURRENT_TIMESTAMP(0),
    PRIMARY KEY (`ID`) USING BTREE,
    INDEX `user_index` (`USER_ID`, `SECTION_ID`) USING BTREE
) ENGINE = InnoDB
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci
...
(
    ...
    `CREATED_TIME` timestamp(0)                                    NOT NULL DEFAULT CURRENT_TIMESTAMP(0),
    PRIMARY KEY (`ID`) USING BTREE,
    INDEX `comment_from_index` (`FROM_ID`, `COMMENT_ID`) USING BTREE
) ENGINE = InnoDB
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci
...
(
    ...
    PRIMARY KEY (`ID`) USING BTREE,
    INDEX `type_kind_index` (`TYPE`, `KIND_NAME`) USING BTREE
) ENGINE = InnoDB
  AUTO_INCREMENT = 23
  CHARACTER SET = utf8
...
INSERT INTO `post`
VALUES (28, 8, 'Java', 'Java Spring框架简介', '啦啦啦啦啦啦', '2019-06-12 14:00:25', 1, 1);
INSERT INTO `post`
...
(
    ...
    `CREATED_TIME` timestamp(0)                                    NOT NULL DEFAULT CURRENT_TIMESTAMP(0),
    PRIMARY KEY (`ID`) USING BTREE,
    INDEX `user_index` (`USER_ID`, `POST_ID`) USING BTREE
) ENGINE = InnoDB
  AUTO_INCREMENT = 8
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci
...
(
    ...
    `CREATED_TIME` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0),
    PRIMARY KEY (`ID`) USING BTREE,
    INDEX `USER_POST_ID` (`USER_ID`, `POST_ID`) USING BTREE
) ENGINE = InnoDB
  AUTO_INCREMENT = 15
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci
...
(
    ...
    `CREATED_TIME` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0),
    PRIMARY KEY (`ID`) USING BTREE,
    INDEX `post_user_index` (`POST_ID`, `USER_ID`) USING BTREE
) ENGINE = InnoDB
  AUTO_INCREMENT = 21
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci
...
(
    ...
    `CREATED_TIME` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0),
    PRIMARY KEY (`ID`) USING BTREE,
    INDEX `USER_COMMENT_ID` (`USER_ID`, `POST_ID`) USING BTREE
) ENGINE = InnoDB
  AUTO_INCREMENT = 17
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci
...
(
    `ID`           bigint(20)                                              NOT NULL AUTO_INCREMENT,
    `NICKNAME`     varchar(127) CHARACTER SET utf8 COLLATE utf8_general_ci NULL     DEFAULT NULL,
    ...
    `SEC_QUESTION` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL     DEFAULT NULL,
    `SEC_ANSWER`   varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL     DEFAULT NULL,
    `HEAD_URL`     varchar(63) CHARACTER SET utf8 COLLATE utf8_general_ci  NULL     DEFAULT NULL,
    `CREATED_TIME` timestamp(0)                                            NOT NULL DEFAULT CURRENT_TIMESTAMP(0),
    `MAJOR`        varchar(15) CHARACTER SET utf8 COLLATE utf8_general_ci  NULL     DEFAULT NULL,
    `AGE`          int(3)                                                  NULL     DEFAULT NULL,
    `SEX`          tinyint(1)                                              NULL     DEFAULT 0,
    PRIMARY KEY (`ID`) USING BTREE,
    INDEX `INDEX` (`EMAIL`, `PASSWORD`) USING BTREE
) ENGINE = InnoDB
  AUTO_INCREMENT = 10
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci
...
INSERT INTO `user`
VALUES (2, '东云1号', 'e10adc3949ba59abbe56e057f20f883e', 'a@qq.com', NULL, NULL, NULL, 'res/default.jpg',
        '2019-06-11 22:34:36', 'Java', 1, 2);
INSERT INTO `user`
...
(
    `ID`           bigint(20)                                             NOT NULL AUTO_INCREMENT,
    `USER_ID`      bigint(20)                                             NOT NULL,
    `FILENAME`     varchar(63) CHARACTER SET utf8 COLLATE utf8_general_ci NULL     DEFAULT NULL,
    `URL`          varchar(63) CHARACTER SET utf8 COLLATE utf8_general_ci NULL     DEFAULT NULL,
    `ISUPLOAD`     tinyint(1)                                             NULL     DEFAULT 0,
    `CREATED_TIME` timestamp(0)                                           NOT NULL DEFAULT CURRENT_TIMESTAMP(0),
    PRIMARY KEY (`ID`) USING BTREE,
    INDEX `user_index` (`USER_ID`, `ISUPLOAD`) USING BTREE,
    INDEX `filename_index` (`FILENAME`) USING BTREE,
